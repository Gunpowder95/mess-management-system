    ...
    if ($count1>0)
    {
        ...
        while($row1 = mysql_fetch_assoc($RecordSet1))
        {
            ...
            if ($count3>0)
            {
                ...
                {
                    $MessID=$row2["MessID"];
                    $query4="select sum(lunch) as lsum from $MessID where Date='$todaydate'";
...
?> 
            ...
            <tr align="center">
                <td colspan="2">
                    <input class="w3-button w3-large w3-text-red" onclick=goTodaySummary() type="button" name="SummaryTodayButton" value="NOT LUNCH ?" style="opacity: 0.85;width: 100%;">
                </td>
            </tr>
            <tr align="center">
                <td colspan="2">
