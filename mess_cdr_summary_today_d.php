...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-dark-grey">
    <div class="w3-display-custom-topmiddle">
        <table border=10 class="w3-animate-bottom" border=0 align="center" style="max-width: 100%;">
            ...
            <tr>
                <td class="w3-large w3-center" colspan="2">TODAY DINNER</td>
            </tr>
           <tr>
...
<?php
    ...
    $totald=0;
    $query1="select * from buddybase.course where '$todaydate' between arrdate and depdate";
    ...
    if ($count1>0)
    {
        ...
        while($row1 = mysql_fetch_assoc($RecordSet1))
        {
            ...
            if ($count3>0)
            {
                ...
                {
                    $MessID=$row2["MessID"];
                    $query4="select sum(dinner) as dsum from $MessID where Date='$todaydate'";
...
?> 
            ...
            <tr align="center">
                <td colspan="2">
                    <input class="w3-button w3-large w3-text-red" onclick=goTodaySummary() type="button" name="SummaryTodayButton" value="NOT DINNER ?" style="opacity: 0.85;width: 100%;">
                </td>
            </tr>
            <tr align="center">
                <td colspan="2">
                    <input class="w3-button w3-large w3-text-red" onclick=goSummaryHome() type="button" name="SummaryHomeButton" value="NOT TODAY ?" style="opacity: 0.85;width: 100%">
                </td>
            </tr>
    		<tr align="center">
                <td colspan="2">
