...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-dark-grey">
    <div class="w3-display-custom-topmiddle">
        <form action="mess_cdr_course_del_final.php" method="POST">
			...
			<tr align="center">
				<td colspan="2">
					<input class="w3-button w3-xlarge w3-text-red" type="submit" name="CourseDeleteSubmit" value="DELETE" style="width: 100%">
				</td>
			</tr>
            <tr align="center">
                <td colspan="2">
