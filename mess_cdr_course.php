...
<script>
	...
	function goSearchCourse()
	{
		window.location="mess_cdr_course_search.php"
	}
	function goDelCourse()
	{
...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-dark-grey">
    <div class="w3-display-custom-topmiddle">
        <table border=10 class="w3-animate-bottom" border=0 align="center" style="max-width: 100%;">
    		<tr>
    			<td class="w3-center" ><h1 class="w3-xxlarge">COURSE</h1></td>
    		</tr>
    		<tr align="center">
    			<td>
    				<input class="w3-button w3-xlarge" onclick=goAddCourse() type="button" name="AddCourseButton" value="ADD" style="opacity: 0.85;width: 100%">
				</td>
    		</tr>
    		<tr align="center">
    			<td>
    				<input class="w3-button w3-xlarge" onclick=goSearchCourse() type="button" name="SearchCourseButton" value="SEARCH" style="opacity: 0.85;float: left;width: 100%">
    			</td>
    			
    		</tr>
    		<tr align="center">
    			<td>
    				<input class="w3-button w3-xlarge" onclick=goDelCourse() type="button" name="DelCourseButton" value="DELETE" style="opacity: 0.85;float: left;width: 100%">
    			</td>			
    		</tr> 
            <tr align="center">
                <td>
