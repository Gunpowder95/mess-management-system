...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-dark-grey">
    <div class="w3-display-custom-topmiddle">
        <table border=10 class="w3-animate-bottom" border=0 align="center" style="max-width: 100%;">
            ...
            <tr>
                <td class="w3-large w3-center" colspan="2">YESTERDAY LUNCH</td>
            </tr>
           <tr>
    ...
    if ($count1>0)
    {
        ...
        while($row1 = mysql_fetch_assoc($RecordSet1))
        {
            ...
            if ($count3>0)
            {
                ...
                {
                    $MessID=$row2["MessID"];
                    $query4="select sum(lunch) as lsum from $MessID where Date='$yesterdaydate'";
...
?> 
            ...
            <tr align="center">
                <td colspan="2">
                    <input class="w3-button w3-large w3-text-red" onclick=goYesterdaySummary() type="button" name="SummaryYesterdayButton" value="NOT LUNCH ?" style="opacity: 0.85;width: 100%;">
                </td>
            </tr>
            <tr align="center">
                <td colspan="2">
