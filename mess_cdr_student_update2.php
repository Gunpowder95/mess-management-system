...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-dark-grey">
    <div class="w3-display-custom-topmiddle">
        <form action="mess_cdr_student_update3.php" method="POST">
        <table border=10 class="w3-animate-bottom" border=0 align="center" style="max-width: 100%;">
    		<tr>
	    		...
	    		<tr class="w3-large">
	    			...
	    			<td>
<?php
						$dummyMessID=$RecordSet1['MessID'];
						echo "<input type='text' name='MessID' value=".$dummyMessID." style='width: 100%;'>";
?>
	    			</td>
	    		</tr>
	    		<tr class="w3-large">
...
<?php
						...
						echo "<input type='text' name='Rank' value=".$dummyRank." style='width: 100%;'>";
?>
	    			</td>
	    		</tr>
	    		<tr class="w3-large">
...
<?php
						...
						echo "<input type='text' name='Name' value=".$dummyName." style='width: 100%;'>";
?>
	    			</td>
	    		</tr>
	    		<tr class="w3-large">
...
<?php
						...
						echo "<input type='text' name='Dining' value=".$dummyDining." style='width: 100%;'>";
?>
	    			</td>
	    		</tr>
	    		<tr class="w3-large">
	    			...
	    			<td>
<?php
						$dummyMeal_Pref=$RecordSet1['MealPref'];
						echo "<input type='text' name='Meal_Pref' value=".$dummyMeal_Pref." style='width: 100%;'>";
?>
	    			</td>
	    		</tr>
	    		<tr class="w3-large">
	    			<td><center>Update Date</center></td>
	    			<td>
	    				<input type="date" name="UpdateDate" style="width: 100%";>
	    			</td>
	    		</tr>
	    		<tr align="center">
					<td colspan="2">
						<input class="w3-button w3-xlarge w3-text-red" type="submit" name="StudentOffrUpdateSubmit" value="UPDATE" style="width: 100%">
					</td>
				</tr>
	    		<tr align="center">
	    			<td colspan="2">
