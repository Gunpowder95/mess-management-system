...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-dark-grey">
    <div class="w3-display-custom-topmiddle">
        <form action="mess_cdr_student_add2.php" method="POST">
        	<table border=10 class="w3-animate-bottom" border=0 align="center" style="max-width: 100%;">
    		<tr>
    			<td class="w3-center" colspan="2"><h1 class="w3-xxlarge">ADD STUDENT OFFR</h1></td>
    		</tr>
    		<tr class="w3-large">
				<td>Faculty</td>
				<td>
			...
			<tr class="w3-large">
				<td>Arrival Date</td>
				<td>
					<input type="date" name="ArrDate" style="width: 100%;">
				</td>
			</tr>
			<tr class="w3-large">
				<td>Dining</td>
				<td>
					<select name="Dining" style="width: 100%;">
			...
			<tr class="w3-large">
				...
				<td>
					<select name="Meal_Pref" style="width: 100%;">
			...
			<tr align="center">
				<td colspan="2">
					<input class="w3-button w3-xlarge w3-text-red" type="submit" name="StudentOffrDetailSubmit" value="SUBMIT" style="width: 100%">
				</td>
			</tr>
            <tr align="center">
                <td colspan="2">
