...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-dark-grey">
    <div class="w3-display-custom-topmiddle">
    	<table border=10 class="w3-animate-bottom" border=0 align="center" style="max-width: 100%;">
    		...
    		<tr align="center">
    			<td>
    				<input class="w3-button w3-xlarge" onclick=goResetMessCdrPwd() type="button" name="ResetMessCdrPwdButton" value="RESET MESS CDR PASSWORD" style="opacity: 0.85;width: 100%">
				</td>
    		</tr>
    		<tr align="center">
    			<td>
