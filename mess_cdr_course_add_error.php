...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-dark-grey">
    <div class="w3-display-custom-topmiddle">
        <form action="mess_cdr_course_add_confirm.php" method="POST">
			...
			<tr class="w3-large">
				...
				<td><input type="text" name="CourseStr" style="width: 100%;"></td>
			</tr>
			<tr class="w3-large">
				<td>Arrival Date</td>
				<td><input type="date" name="ArrDate" style="width: 100%;"></td>
			</tr>	
			<tr class="w3-large">
				<td>Departure Date</td>
				<td><input type="date" name="DepDate" style="width: 100%;"></td>
			</tr>
			<tr class="w3-large">
				<td colspan=2 align="center" style="color: red;">Error !! Try Again</td>
			</tr>	
			<tr align="center">
				<td colspan="2">
					<input class="w3-button w3-xlarge w3-text-red" type="submit" name="CourseDetailSubmit" value="SUBMIT" style="width: 100%">
				</td>
			</tr>
            <tr align="center">
                <td colspan="2">
