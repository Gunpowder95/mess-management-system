...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-dark-grey">
    <div class="w3-display-custom-topmiddle">
        <form action="mess_cdr_student_del2.php" method="POST">
        	<table border=10 class="w3-animate-bottom" border=0 align="center" style="max-width: 100%;">
    		<tr>
	    			<td class="w3-center" colspan="2"><h1 class="w3-xxlarge">DELETE STUDENT OFFR</h1></td>
	    		</tr>
	    		<tr class="w3-large">
	    		...
	    		<tr align="center">
					<td colspan="2">
						<input class="w3-button w3-xlarge w3-text-red" type="submit" name="StudentOffrDeleteSubmit" value="DELETE" style="width: 100%">
					</td>
				</tr>
	    		<tr align="center">
	    			<td colspan="2">
