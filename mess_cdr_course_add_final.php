...
<div class="bgimg w3-display-container w3-animate-opacity w3-text-dark-grey">
    <div class="w3-display-custom-topmiddle">
        <table border=10 class="w3-animate-bottom" border=0 align="center" style="max-width: 100%;">
    		<tr>
                <td class="w3-center">
                    <input class="w3-button w3-xxlarge w3-text-red" onclick=goCourse() type="button" name="CourseButton" value="COURSE" style="opacity: 0.85;float: left;width: 100%">
                </td> 
            </tr>
            <tr align="center">
                <td>
            ...
            <tr>
                <td colspan=2 align="center" style="color: red;">Course Added Successfully</td>
            </tr>
    		<tr align="center">
    			<td>
